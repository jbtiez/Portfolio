...
- Among the methods we utilized were basic word frequency analysis, sentiment analysis using VADER, word embeddings (w/ Word2Vec). This project culiminated in a published academic paper ([click here for abstract](https://ieeexplore.ieee.org/document/9106584); full paper requires subscription)
